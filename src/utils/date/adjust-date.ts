...
export const transformToDate = (date:string|Date, type?:typeProps) =>{
    date = date.toString();
...
export const barteDate = () =>{
    return `${year}-${(month+1).toString().padStart(2, '0')}-${today.toString().padStart(2, '0')}`
}
